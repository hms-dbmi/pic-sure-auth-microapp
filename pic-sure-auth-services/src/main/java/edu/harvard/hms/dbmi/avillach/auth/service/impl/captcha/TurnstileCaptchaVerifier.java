...
/**
 * Verifies Cloudflare Turnstile tokens against the siteverify endpoint. Fails closed: any
 * verification error (network, non-2xx, malformed response) rejects the key mint rather than
 * silently disabling the abuse gate.
 */
@Service
