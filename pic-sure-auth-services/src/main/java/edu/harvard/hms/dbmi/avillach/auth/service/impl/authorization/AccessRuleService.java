...
public class AccessRuleService {
    ...
    public void populateAccessRule(AccessRule rule, boolean includeParent, boolean includeHarmonized, boolean includeTopmed) {
        ...
        this.accessRuleRepo.save(rule);
    }

    public void populateHarmonizedAccessRule(AccessRule rule, String parentConceptPath, String studyIdentifier, String projectAlias) {
        if (rule.getGates() == null) {
    ...
    public void addStandardAccessRules(Set<AccessRule> accessRules) {
        if (standardAccessRules != null && !standardAccessRules.isEmpty()) {
            ...
            for (String arName : fence_standard_access_rules.split(",")) {
                if (arName.startsWith("AR_")) {
                    ...
                    AccessRule ar = getAccessRuleByName(arName);
                    if (ar != null) {
     ...
     */
    public AccessRule createConsentAccessRule(String studyIdentifier, String consent_group, String label, String consent_path) {
     ...
     * @return              The created AccessRule.
     */
    public AccessRule upsertTopmedAccessRule(String project_name, String consent_group, String label) {
     ...
     * @return              The created AccessRule.
     */
    public AccessRule upsertHarmonizedAccessRule(String project_name, String consent_group, String label) {
    ...
    private AccessRule getOrCreateAccessRule(String name, String description, String rule, int type, String value, boolean checkMapKeyOnly, boolean checkMapNode, boolean evaluateOnlyByGates, boolean gateAnyRelation) {
        return accessRuleCache.computeIfAbsent(name, key -> {
            AccessRule ar = getAccessRuleByName(key);
            if (ar == null) {
     ...
     */
    public void configureAccessRule(AccessRule ar, String studyIdentifier, String consent_group, String conceptPath, String projectAlias, boolean parent, boolean harmonized, boolean topmed) {
        if (ar.getGates() == null) {
     ...
     * @param projectAlias      The project alias.
     */
    public void configureHarmonizedAccessRule(AccessRule ar, String studyIdentifier, String consent_group, String conceptPath, String projectAlias) {
        if (ar.getGates() == null) {
            ar.setGates(new HashSet<>());
    ...
    private AccessRule upsertTopmedRestrictedSubRule(String type, String rule) {
        ...
        AccessRule ar = getAccessRuleByName(ar_name);
        if (ar != null) {
    ...
    public Collection<? extends AccessRule> getPhenotypeSubRules(String studyIdentifier, String conceptPath, String alias) {
     ...
     * @return
     */
    public Collection<? extends AccessRule> getPhenotypeRestrictedSubRules(String studyIdentifier, String consentCode, String alias) {
        Set<AccessRule> rules = new HashSet<AccessRule>();
        //categorical filters will always contain at least one entry (for the consent groups); it will never be empty
        rules.add(createPhenotypeSubRule(fence_topmed_consent_group_concept_path, "ALLOW_TOPMED_CONSENT", "$.query.query.categoryFilters", AccessRule.TypeNaming.ALL_CONTAINS, "", true));
