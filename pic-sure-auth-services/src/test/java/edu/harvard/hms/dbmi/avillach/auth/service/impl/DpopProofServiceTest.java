...
public class DpopProofServiceTest {
    ...
    @Test
    public void createProof_omitsNonceClaim_whenBlank() throws Exception {
        String proof = service.createProof("POST", "https://example.okta.com/oauth2/v1/token", "  ", null);

        assertFalse(segment(proof, 1).has("nonce"));
    }
