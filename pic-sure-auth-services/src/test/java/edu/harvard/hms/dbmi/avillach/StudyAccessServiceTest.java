...
public class StudyAccessServiceTest {
    ...
    public void testAddStudyAccess() {
        ...
        when(fenceUtilityMapping.getFENCEMapping()).thenReturn(Map.of(studyIdentifier, Map.of(StudyAccessService.STUDY_IDENTIFIER, studyIdentifier,StudyAccessService.CONSENT_GROUP_CODE, "")));
    ...
    public void testAddStudyAccessWithConsent() {
        ...
        when(fenceUtilityMapping.getFENCEMapping()).thenReturn(Map.of(studyIdentifier, Map.of(StudyAccessService.STUDY_IDENTIFIER, "testStudy2", StudyAccessService.CONSENT_GROUP_CODE, "c2")));
