...
public class RASPassPortServiceTest {
    ...
    public void testValidateVisa_Valid() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("validPassport");
    ...
    public void testValidateVisa_Invalid() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("invalidPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_Missing() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("missingPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidatePassport_InvalidVisa() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("invalidFormatPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_VisaExpired() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("expiredVisaPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_TxnError() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("txnErrorPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_ExpirationError() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("expirationErrorPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_ValidationError() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("validationErrorPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_ExpiredPolling() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("expiredPollingPassport");
        assertTrue(response.isPresent());
    ...
    public void testValidateVisa_PermissionUpdate() {
        ...
        Optional<String> response = rasPassPortService.validateVisa("permissionUpdatePassport");
        assertTrue(response.isPresent());
